...
-- Mappings to auto-close parentheses, brackets, etc..
...
vim.keymap.set('n', '<C-a><C-c>', function()
  -- Save the current file before copying
  vim.cmd 'w'

  -- Use Lua to copy the file content to the clipboard
  local file = vim.fn.expand '%' -- Get the current file path
  local command = 'wl-copy < ' .. file -- Build the command
  vim.fn.system(command) -- Execute the command

  -- Optionally, you can notify the user
  vim.notify('File content copied to clipboard', 'info')
